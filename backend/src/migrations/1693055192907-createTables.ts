...
export class CreateTables1693055192907 implements MigrationInterface {
    name = 'CreateTables1693055192907'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pictures" ("id" SERIAL NOT NULL, "coverImage" text NOT NULL, "image01" text NOT NULL, "image02" text NOT NULL, "image03" text, "image04" text, "image05" text, "image06" text, "carId" integer, CONSTRAINT "REL_920495d35b62eb8dee68673ce7" UNIQUE ("carId"), CONSTRAINT "PK_7aa5e10dd31983e9f05b9f1fc85" PRIMARY KEY ("id"))`);
